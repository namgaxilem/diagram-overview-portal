  ...
  return (
    <div className="relative">
      ...
      {nodeData.hasApi !== false && (
        <div className={`absolute ${nodeData.variant === "omw" ? "-bottom-3" : "-top-3"} left-1/2 -translate-x-1/2 z-20`}>
      ...
      {nodeData.variant !== "omw" && <Handle type="target" position={Position.Top} className="!bg-sky-500 !w-2 !h-2" />}
