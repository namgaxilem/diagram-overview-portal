          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative">
              <div className="w-24 h-24 bg-white border border-gray-200 rounded-xl shadow-sm flex items-center justify-center p-4">
                ...
                >
                  <path
                    d="M30 80 L50 20 L70 80 M40 60 L60 60"
                    strokeLinecap="round"
              ...
              <div className="mt-2 flex items-center gap-3">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center text-xs">
                    <span className="text-gray-400 mr-2 uppercase tracking-wide font-semibold text-[10px]">
                      Status:
                    </span>
          ...
          <div className="space-y-6">
            <div className="max-w-4xl space-y-6">
              ...
              <article className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-6 text-sm text-gray-600 leading-relaxed">Coding agent</div>
              </article>
              ...
              <article className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-6 text-sm text-gray-600 leading-relaxed">
                  Rewrite the following prompt to be more explicit, logically structured, and
                  optimized for LLM execution:
                  <br />
                  <br />
                  <strong className="text-gray-800">**Prompt:**</strong> Act as a &quot;Code
                  Agent.&quot; When given a coding task, provide clear, step-by-step solutions,
                  including code examples, concise explanations, and best practices. Ensure your
                  responses are accurate, well-structured, and easy to follow. If additional
                  information is needed, ask clarifying questions before proceeding.
                </div>
              </article>
            </div>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Define the properties that the agent must include in its structured response. Each
                  property has a name, type, optional description, and can be marked as required.
                </p>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-12 gap-4 items-center">
                    ...
                    <div className="col-span-12 pl-8 space-y-3">
                      <input
                        className="w-full border-gray-300 rounded-lg text-sm bg-gray-50/50"
    ...
    "jhkljkl"
        ...
        {activeTab !== 'overview' && activeTab !== 'output' && (
          <div className="flex flex-col items-center justify-center min-h-[400px] text-gray-400">
            ...
            <p className="text-sm">
              Please select &apos;Overview&apos; or &apos;Output Schema&apos; for full preview.
            </p>
          </div>
        )}
      </div>
