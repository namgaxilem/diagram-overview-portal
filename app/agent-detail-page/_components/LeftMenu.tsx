  ...
  return (
    <aside className="w-64 bg-[#1a1c1e] text-gray-400 flex flex-col shrink-0 border-r border-gray-800">
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-4 space-y-6">
        <div>
          <a className="flex items-center gap-3 px-3 py-2 text-brand-accent bg-brand-green/10 rounded-md" href="#">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
              <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
            </svg>
            <span>Dashboard</span>
          </a>
          <a className="flex items-center gap-3 px-3 py-2 mt-1 hover:bg-gray-800 rounded-md" href="#">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div>
          <p className="px-3 text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-2">Agentic</p>
      ...
      <div className="mt-auto border-t border-gray-800 p-4">
        <div className="bg-gray-800/40 rounded-lg p-3 flex items-center gap-3 mb-4">
          <div className="w-8 h-8 rounded bg-teal-600 flex items-center justify-center text-white text-xs font-bold">VT</div>
