    ...
    <header className="bg-brand-green text-white h-14 flex items-center justify-between px-4 shrink-0 z-50">
      <div className="flex items-center gap-4">
        <div className="bg-white p-1 rounded">
          <div className="w-6 h-6 bg-brand-green flex items-center justify-center font-bold text-xs">H</div>
        </div>
      ...
      <div className="flex items-center gap-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          <div className="bg-orange-500 w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs uppercase">QV</div>
